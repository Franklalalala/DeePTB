...
def common_options():
    ...
    doc_nextham_uureal_mask = "Whether to use NextHAM-style uu.real masking on SOC RME features. Default: False"
...
def flow_options():
    ...
    args = [
        ...
        Argument("pixel_meanflow", dict, optional=True, default={}),
...
def train_options():
    ...
    doc_optimizer = "\
        The optimizer setting for selecting the gradient optimizer of model training. Optimizer supported includes `Adam`, `AdamW`, `HybridMuon`, `SGD` and `LBFGS` \n\n\
...
def lr_scheduler():
    doc_type = "select type of lr_scheduler, support type includes `exp`, `linear`, `qhflow_poly`"
