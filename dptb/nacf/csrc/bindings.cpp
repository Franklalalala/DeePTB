...
torch::Tensor nacf_onsite_density(torch::Tensor,torch::Tensor,torch::Tensor,torch::Tensor,torch::Tensor,torch::Tensor,torch::Tensor,torch::Tensor,torch::Tensor,torch::Tensor,torch::Tensor,double);
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("onsite_density", &nacf_onsite_density,
        "Batched onsite density of species-segmented candidate neighbour lists on one quadrature grid, "
        "accepted chunk order, exact triangle-inequality pair skipping (CUDA)");
