...
from dptb.nn.blockwise_hamiltonian import (
    ...
    DirectBlockwiseE3Hamiltonian,
    StructuredBlockwiseE3Hamiltonian,
)
...
class NNENV(nn.Module):
    ...
    def __init__(
        ...
        self.structured_blockwise_hamiltonian = bool(prediction_copy.get("structured_blockwise_hamiltonian", False))
        ...
        self.blockwise_hamiltonian = bool(
            ...
            or self.structured_blockwise_hamiltonian
        )
        ...
        if self.method == "sktb":
            ...
            if self.structured_blockwise_hamiltonian:
                hamiltonian_cls = StructuredBlockwiseE3Hamiltonian
