...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    m.def("validate_candidate_capacity", &local_check::candidate_capacity,
          "Validate candidate scan counts without allocating CUDA outputs");
    m.def("validate_support_capacity", &local_check::support_capacity,
          "Validate host counts without allocating CUDA outputs");
