...
@pytest.mark.parametrize('method', ['lem_moe_v3_prior_2b', 'lem_moe_v3_edge_prior_2b'])
def test_loader_preserves_native_model_backend_unless_reference_is_explicit(tmp_path, monkeypatch, model_backend, method):
    options = {'embedding': {'method':method, 'prior_kind':'na_cf',
