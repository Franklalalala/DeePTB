...
class LMDBDataset(AtomicDataset):
    ...
    def get(self, idx):
        ...
        # Optional AO-block targets/H0 produced by tools/convert_feature_lmdb_to_blockwise.py.
        # Keeping this side-channel here leaves the feature training path unchanged.
