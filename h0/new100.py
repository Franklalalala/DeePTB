...
def worker(cid):
    ...
    try:
        ...
        budgets=memory_budgets();report['memory_budgets']=budgets
        ...
        report.update(reader_revision='atomic-mag/v2', field_revision='ABACUS-reader-signed-PW-builtin-PBE/v6',
            xc_reference_dispatch='ABACUS built-in PBE; split original PW/corrections and signed spin channels',
        ...
        got=assemble_h0(st,sd,**opts,two_center_backend='pyabacus',two_center_cache_dir=str(ROOT/'tmp'),
            ...
            structure_factor_nthreads=1,**budgets)
