...
class P2MemoryInitLayer(torch.nn.Module):
    ...
    def forward(
        ...
        if self.soft_edge_memory is not None:
            ...
            data["soft_edge_memory_attention_entropy"] = diagnostics[
                "attention_entropy"
            ]
            data["soft_edge_memory_attention_max_probability"] = diagnostics[
                "attention_max_probability"
            ]
            data["soft_edge_memory_gate_mean"] = diagnostics["gate_mean"]
