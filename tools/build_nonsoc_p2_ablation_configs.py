...
def _data_split(
    ...
    *,
    ...
    result = {
        ...
        "require_p2_blocks": bool(get_p2 and require_full_h_target),
        "require_full_h_target": bool(require_full_h_target),
    ...
    if get_p2 and expected_p2_source_fingerprint:
        result["expected_p2_source_fingerprint"] = expected_p2_source_fingerprint
    return result
...
def _loss(*, full_output: bool, absolute_full_h_target: bool) -> dict[str, Any]:
    loss: dict[str, Any] = {
        ...
        "target_node_block_key": (
            ...
            else "node_delta_hamil_blocks"
        ),
        "target_edge_block_key": (
            "edge_full_hamil_target_blocks"
            if absolute_full_h_target
            else "edge_delta_hamil_blocks"
        ),
        "target_node_shape_key": (
            "node_full_hamil_target_block_shape"
            if absolute_full_h_target
            else "node_delta_hamil_block_shape"
        ),
        "target_edge_shape_key": (
    ...
    return {
        ...
        "loss_options": {
            "train": _loss(
                ...
                absolute_full_h_target=absolute_full_h_target,
            ),
            "validation": _loss(
                full_output=full_output,
                absolute_full_h_target=absolute_full_h_target,
...
def build_configs(
    *,
    ...
    for name, variant in variants.items():
        ...
        config = {
            ...
            "train_options": _train_options(
                ...
                absolute_full_h_target=bool(variant["absolute_full_h_target"]),
            ),
            "data_options": {
                "train": _data_split(
                    view / "train",
                    ...
                    require_full_h_target=bool(variant["absolute_full_h_target"]),
                    expected_p2_source_fingerprint=expected_p2_source_fingerprint,
                ),
    ...
    context["data_options"]["train"]["audit_p2_representations"] = True
